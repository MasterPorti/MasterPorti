...
* **[Robokids](https://app.robokidsedu.com)**: Plataforma educativa SaaS para niños.
    * *Stack:* Next.js, Supabase, Stripe (Subscriptions), Cloudflare.
* **[Tecnocoms](https://tecnocoms.mx)**: Servicios de hosting y desarrollo web.
    * *Stack:* cPanel, PHP, Node.js.
* **HomeLab / VPS**: Gestión de infraestructura propia con Coolify y Mailcow (Dockerized).
